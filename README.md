...
as a custom domain. Cloudflare manages DNS and TLS. CI reads the uploaded version ID from Wrangler’s structured output
and deploys that exact version to all traffic, preserving domain
